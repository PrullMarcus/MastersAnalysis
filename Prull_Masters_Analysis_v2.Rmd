...
```
estimate 4 cms, vector that is n_mon long, 1, 2, 3, 4, 4 cms, 1 for each season. cm is all mortalities
...
theta=qlogis(c(.3,lambda = c(.8,.9),u = rep(0.1,n_mon)))
...
theta=qlogis(c(rep(0.3,4),lambda = c(.8,.9),u = rep(0.1,n_mon)))
