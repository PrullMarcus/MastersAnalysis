...
test = test[with(test,order(factor(test$MonthYear, levels = MonthYearOrder),factor(test$TaggingGroup, levels = TagTypeOrder))),]
```

Here is adding a column for each monthly period. I just filled the value with NAs to start. Also, can get rid fo the third column...
```{r}
test[,Period_Seq] = NA
test
```
