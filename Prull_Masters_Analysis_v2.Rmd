...
n_tag_hi_sin = #c(Dec 2021, Dec2022, Jan2023, May 2023)
...
n_rel=4# I assume 3 due to 3 tag release events? 
n_yrs=#???? #monthly periods (number total). 

S=matrix(NA,nrow=n_rel,ncol=n_yrs)#Survival???

#PROB OF RETURN #DOUBLE THIS
...
#Hi = 300, Med = 200, Low = 100 ACTUAL NUMBER DOUBLE THESE
